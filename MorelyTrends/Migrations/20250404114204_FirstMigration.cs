        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seller_ApplicationUser_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payouts_Seller_SellerId",
                        column: x => x.SellerId,
                        principalTable: "Seller",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderStatuss_OrderStatusValues_OrderStatusValueId",
                        column: x => x.OrderStatusValueId,
                        principalTable: "OrderStatusValues",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderStatuss_Orders_OrderId1",
                        column: x => x.OrderId1,
                        principalTable: "Orders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatuss_OrderId1",
                table: "OrderStatuss",
                column: "OrderId1");

            migrationBuilder.CreateIndex(
                name: "IX_OrderStatuss_OrderStatusValueId",
                table: "OrderStatuss",
